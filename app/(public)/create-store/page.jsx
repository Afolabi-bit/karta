...
export default function CreateStore() {
  ...
  if (!user) {
    return (
      <div className="min-h-[80vh] mx-6 text-slate-400 flex items-center justify-center">
        <h1 className="text-2xl md:text-3xl font-semibold text-center max-w-md mx-5">
          ...
          >
            ...
            <div>
              ...
              <p className="max-w-lg">
                To become a seller on Karta, submit your store details for
