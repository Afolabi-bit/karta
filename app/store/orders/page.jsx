          ...
          <table className="w-full text-sm text-left text-gray-600">
            ...
            <tbody className="divide-y divide-gray-100">
              {orders.map((order, index) => (
                ...
                >
                  <td className="pl-6 text-[#E59500] font-medium">{index + 1}</td>
                  ...
                  <td className="px-4 py-3">
                    {order.isCouponUsed ? (
                      <span className="bg-[#E59500]/10 text-[#E59500] font-medium text-xs px-2 py-1 rounded-full">
                        {order.coupon?.code}
                      </span>
                    ) : (
                      "—"
      ...
      {isModalOpen && selectedOrder && (
        ...
        >
          ...
          >
            ...
            {/* Customer Details */}
            <div className="mb-4">
              <h3 className="font-semibold mb-2 text-[#002642]">Customer Details</h3>
              <p>
