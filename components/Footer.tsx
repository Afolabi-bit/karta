...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#002642] text-slate-300 pt-16 pb-8 border-t border-[#00355C]">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
          <Link
            href="/"
            className="flex items-center gap-2.5 text-3xl font-bold tracking-tight text-white group mb-4"
          >
            <KartaLogoIcon className="w-8 h-8 group-hover:scale-105 transition-transform" />
            <span>
              <span className="text-[#E59500]">K</span>arta
              <span className="text-[#E59500] text-4xl leading-none">.</span>
            </span>
          </Link>
